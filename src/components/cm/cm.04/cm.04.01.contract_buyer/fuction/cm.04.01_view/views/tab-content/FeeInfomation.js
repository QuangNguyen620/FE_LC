            ...
            <Row>
              <Col span={23}>
                ...
                <Row>
                  <Col span={1}></Col>
                  <Col span={7}>
                    <Form.Item>Thuế VAT(10%)</Form.Item>
                    <span className={'text-require'}></span>
                  </Col>
                  <Col span={16}>
                ...
                <Row>
                  <Col span={1}></Col>
                  <Col span={7}>
                    <Form.Item> Tổng phí</Form.Item>
                    <span className={'text-require'}></span>
                  </Col>
                  <Col span={16}>
                    <Form.Item name={'totalFee'} className={'total-fee-view'}>
