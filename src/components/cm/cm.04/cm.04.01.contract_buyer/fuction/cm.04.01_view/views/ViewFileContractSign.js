...
import SignSuccessModal from '../../../components/modal/sign/modal/SignSuccessModal';
import CertificateModal from '../../../components/modal/sign/modal/CertificateModal';
import CertificateDownloadModal from '../../../components/modal/sign/modal/CertificateDownloadModal';
...
const ConstractInfomation = ({ lang = 'vi' }) => {
  ...
  useEffect(() => {
    ...
    // setUrlFile("C:/Users/ADMIN/Downloads/FileContract.pdf");
  }, [context]);
  ...
  const handleRejectOk = (values) => {
    ...
    if (check) {
      ...
      domain.rejectSignatureCheckerBuyer(reason);
      // setShowRejectVisible(false);
    } else {
  ...
  const handleSubmitSignDigital = (values) => {
    ...
    if (check) {
      domain.signDigitalCheckerBuyer(otp);
    } else {
  ...
  function submitHandler() {
    ...
    //   domain.signByTokenCheckerBuyer();
    // } else {
                    ...
                    <Row>
                      ...
                      <Col span={12}>
                        ...
                        >
                          <Button
                            style={{
                              display: context?.showButtonSign
                                ? 'flex'
                                : 'none',
                            }}
