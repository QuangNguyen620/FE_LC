...
const ConstractInfomation = ({ lang = 'vi' }) => {
  ...
  function onChangeAddendumName(e, key) {
    ...
    // var tempList = contractAddendum;
    // tempList[idx]['addendumName'+key] = e.target.value;
  ...
  function onChangeAddendumContent(e, key) {
    ...
    // var tempList = contractAddendum;
    // tempList[idx]['addendumContent'+key] = e.target.value;
  ...
  return (
    <>
      <div className={'container-addendum'}>
        {/* <Row className="row-btn-addendum">
          <Col span={24}>
            <Button
              className="common-btn btn-adendum"
              onClick={() => {
                add();
              }}
            >
