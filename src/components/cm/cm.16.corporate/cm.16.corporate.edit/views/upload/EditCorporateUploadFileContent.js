...
import './EditCorporateUpload.less';
...
const EditCorporateUploadFileContent = ({ lang = 'vi', ...props }) => {
  ...
  return (
    <>
      <div class="upload-file-form-container" style={{ display: context?.viewEditUpload }}>
...
export default EditCorporateUploadFileContent;
