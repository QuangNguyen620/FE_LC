                ...
                <Row>
                  ...
                  <Col span={8}>
                    {context?.lcApplication?.contractType == 2 ? (
                      ...
                      <Form.Item name={'lastestDeliveryDate'}>
                        <DatePicker
                          style={{ width: '100%' }}
                          format={dateFormatList}
                          placeholder="dd/mm/yyyy"
                  ...
                  <Col span={16}>
                    {context?.lcApplication?.contractType == 2 ? (
                      ...
                      <Form.Item name={'deliveryTime'}>
                        <Input name="deliveryTime" disabled />
                      </Form.Item>
                    )}
                  </Col>
                </Row>
                {(context?.lcApplication?.status == LC_STATUS.TU_CHOI_DRAFT ||
                  ...
                  context?.initLCType == LC_TYPE.UPAS_LC && (
                    <Row>
                      ...
                      <Col span={16}>
                        {context?.lcApplication?.contractType == 2 ? (
                          <Form.Item name={'typeOfGood'}>
                            <Select disabled placeholder="Chọn">
                              {context?.constantValue?.goodTypeList?.map(
                                (goodType) => (
