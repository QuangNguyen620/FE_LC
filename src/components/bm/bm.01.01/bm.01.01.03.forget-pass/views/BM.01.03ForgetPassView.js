...
import './BM.01.03ForgetPass.less';
import { useA00Domain } from '../domains/BM.01.03Domain';
...
const BM0103ForgetPassView = ({ lang = 'vi', ...props }) => {
        ...
        axios(result)
          .then(function (response) {
            ...
            if (response.data == 'User does not exist') {
              ...
              //message.info('Thông tin mật khẩu đã được gửi vào hòm thư!');
