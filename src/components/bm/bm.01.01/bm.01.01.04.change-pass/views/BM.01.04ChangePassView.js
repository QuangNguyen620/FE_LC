...
import './BM.01.04ChangePass.less';
import { useA00Domain } from '../domains/BM.01.04Domain';
...
const BM010104ChangePassView = ({ lang = 'vi', ...props }) => {
          ...
          >
            ...
            {/* <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập nhập mật khẩu hiện tại!',
                  },
                ]}
              >
                <Input.Password />
...
export default BM010104ChangePassView;
