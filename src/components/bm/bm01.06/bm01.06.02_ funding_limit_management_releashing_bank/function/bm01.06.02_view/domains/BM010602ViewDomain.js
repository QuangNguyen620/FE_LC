...
import useBM010601Service from '../services/BM010602ViewContextService';
...
export function BM010601Domain() {
  ...
  const exitHandler = () => {
    history.push('/bm-home/funding-limit-management-release-bank');
  };

  const editHandler = (id) => {
    history.push(`/bm-home/funding-limit-management-release-bank/edit/${id}`);
  };
